...
/**
 * @param {Omit<Toast, 'id' | 'open' | 'onOpenChange'> & { open?: boolean; onOpenChange?: (open: boolean) => void }} props
...
/**
 * @returns {{ toasts: Array<Toast>, toast: typeof toast, dismiss: (toastId: string) => void }}
 */
function useToast() {
